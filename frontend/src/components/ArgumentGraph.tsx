...
function ArgumentNodeCard({ data }: NodeProps<NodeData>) {
  ...
  const displayText =
    n.ai_summary ??
    (n.content.length > 85 ? n.content.slice(0, 85) + '\u2026' : n.content)
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '8px 10px', minHeight: 48 }}>
        <p
          style={{ margin: 0, fontSize: 11, lineHeight: 1.5, color: '#e2e4e9' }}
        >
          {displayText}
        </p>
        {n.ai_summary && (
      ...
      <div style={{ flex: 1, minHeight: 400 }}>
        ...
        >
          ...
          <Controls
            ...
            style={{ borderRadius: 6, boxShadow: '0 2px 8px rgba(0,0,0,0.3)' }}
          />
          <MiniMap
            nodeColor={(n) =>
